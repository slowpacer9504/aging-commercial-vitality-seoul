...
- New enterprise survival rates are reconstructed as-of into administrative dong-quarter rows using a 3-year block based on Q4 requests for reference years `2019`, `2022`, and `2025`. `survival_3y` is used in the active structural stability sub-index.
