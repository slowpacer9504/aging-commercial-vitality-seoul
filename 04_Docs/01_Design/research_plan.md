...
- **RQ1. 고령화가 근린 상업활력에 미치는 직접적 영향**
  - 고령 상주인구 비율의 증가가 해당 행정동 근린 상권의 다차원적 상업활력(경제적 활성도, 사회적 활성도, 시간적 지속성, 구조적 안정성)에 미치는 직접적인 영향의 방향과 크기는 어떠한가?
  - 고령화가 점포의 양적 쇠퇴(매출/유동 감소)뿐만 아니라 구조적 적응(점포 존속성 유지 등)의 재편 요인으로 작동하는가?

- **RQ2. 공간적 상호의존성과 파급효과 (Spatial Spillover)**
  - 고령화 지표와 상업활력 간에 유의한 공간적 자기상관 및 상호의존성이 존재하는가?
  - 공간 패널 모형(SPDM)으로 추정한 고령화의 간접효과(Spillover)는 상업활력의 4대 차원에 따라 어떠한 전이 패턴을 보이는가?

- **RQ3. 시공간적 이질성 (Spatiotemporal Heterogeneity)**
  - 고령화가 상업활력에 미치는 영향은 서울시 내의 지리적 생활권(공간) 및 분기 흐름(시간)에 따라 어떠한 국지적 이질성을 나타내는가?
  - 고령화 밀집도나 소비 여건 등 지역적 배후 특성에 따라 상권의 복원력이나 적응 양상에 차이가 존재하는가?

`aging x covid_period` 상호작용 및 대체 지표 민감도 등은 robustness와 부록에서 다루며, 본문 실증 서사는 위 세 가지 핵심 연구질문을 중심으로 전개한다.
